...
<div class="jb-box">
	<div class="video-container">
		<video muted autoplay loop class="fullscreen-video active">
			<source
				src="https://cdn.pixabay.com/video/2023/10/30/187124-879581216_tiny.mp4"
			>
		</video>
		<video muted autoplay loop class="fullscreen-video">
			<source
				src="https://cdn.pixabay.com/video/2023/10/27/186650-878853396_tiny.mp4"
			>
		</video>
		<video muted autoplay loop class="fullscreen-video">
			<source
				src="https://cdn.pixabay.com/video/2022/11/15/139099-771365979_tiny.mp4"
			>
		</video>
	</div>
	<div class="text-box">
		<h2 style="color: white;">2024년 단풍 시즌</h2>
		<p class="spring-info" style="color: #d45e00;">
			대전, 충청도 <span style="font-size: 32px;">도시 속 단풍 보러가자!</span>
		</p>
		<p class="spring-greeting" style="color: white; font-size: 24px;">안녕, 가을!</p>
		<p style="color: white; font-size: 24px;">올 가을엔 GABODA와 함께!</p>
	</div>
</div>
...
<div class="nav-box">
	<div class="text-box2">
		<h2>
			가을, 시즌 <span class="bold" style="font-weight: 800;">여행지</span>
		</h2>
