...
<div class="jb-box">
	<div class="video-container">
		<video muted autoplay loop class="fullscreen-video active">
			<source
				src="https://cdn.pixabay.com/video/2023/11/30/191443-890121806_tiny.mp4"
			>
		</video>
		<video muted autoplay loop class="fullscreen-video">
			<source
				src="https://cdn.pixabay.com/video/2019/02/22/21587-319373323_tiny.mp4"
			>
		</video>
		<video muted autoplay loop class="fullscreen-video">
			<source
				src="https://cdn.pixabay.com/video/2021/10/29/93834-641767481_tiny.mp4"
			>
		</video>
	</div>
	<div class="text-box">
		<h2 style="color: white;">2024년 winter 시즌</h2>
		<p class="spring-info" style="color: white;">
			대전, 충청도 <span style="font-size: 32px;">스키장 갈까?</span>
		</p>
		<p class="spring-greeting" style="color: white; font-size: 24px;">안녕, 겨울!</p>
		<p style="color: white; font-size: 24px;">올 겨울엔 GABODA와 함께!</p>
	</div>
</div>
...
<div class="nav-box">
	<div class="text-box2">
		<h2>
			겨울, 시즌 <span class="bold" style="font-weight: 800;">여행지</span>
		</h2>
